...
<p><strong>{{ \App\CPU\translate('نوع الفاتورة') }}:</strong>
   فاتورة مردود مشتريات
        ...
        <p><strong>{{ \App\CPU\translate('اسم العميل') }}:</strong> {{ optional($order->supplier)->name }}</p>
        <p><strong>{{ \App\CPU\translate('رقم السجل التجاري') }}:</strong> {{ optional($order->supplier)->c_history }}</p>
        <p><strong>{{ \App\CPU\translate('رقم الضريبي') }}:</strong> {{ optional($order->supplier)->tax_number }}</p>
