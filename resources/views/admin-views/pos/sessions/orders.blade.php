...
<div class="content container-fluid">
  {{-- ===== Breadcrumb ===== --}}
@php
    // لو النوع جاي من الراوت/الريكويست أو متغير محلي
    $isReturns    = ($type ?? request('type')) == 'returns';
    $pageTitle    = $isReturns ? 'مرتجعات الكاشير' : 'فواتير مبيعات الكاشير';
    $filtersTitle = $isReturns ? 'بحث وفلاتر مرتجعات الكاشير' : 'بحث وفلاتر مبيعات الكاشير';
@endphp
...
<div class="filter-card mb-3">
  <div class="filter-head d-flex align-items-center justify-content-between">
    <h4 class="mb-0">{{ \App\CPU\translate($filtersTitle) }}</h4>
    @if($hasFilters)
