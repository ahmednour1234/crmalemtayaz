...
@section('title', \App\CPU\translate('إعداد المتجر'))
@push('css_or_js')
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('اسم المتجر') }} </label>
                                        <input type="text" name="shop_name" value="{{ $shop_name }}"
                                            class="form-control" placeholder="{{ \App\CPU\translate('اسم المتجر') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shop_email = \App\Models\BusinessSetting::where('key', 'shop_email')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('بريد المتجر') }} </label>
                                        <input type="email" name="shop_email" value="{{ $shop_email }}"
                                            class="form-control" placeholder="{{ \App\CPU\translate('بريد المتجر') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shop_phone = \App\Models\BusinessSetting::where('key', 'shop_phone')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('هاتف المتجر') }} </label>
                                        <input type="text" name="shop_phone" value="{{ $shop_phone }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('هاتف المتجر') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($shop_address = \App\Models\BusinessSetting::where('key', 'shop_address')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('عنوان المتجر') }}</label>
                                        <input type="text" name="shop_address" value="{{ $shop_address }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('عنوان المتجر') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('حد الصفحات') }}</label>
                                        <input min="1" type="number" name="pagination_limit" value="{{ $pagination_limit }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('حد الصفحات') }}" id="pagination_limit" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($currency_code = \App\Models\BusinessSetting::where('key', 'currency')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('العملة') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    <div class="form-group">
                                        <label class="input-label" for="country">{{ \App\CPU\translate('البلد') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('نص التذييل') }}</label>
                                        <input type="text" name="footer_text" value="{{ $footer_text }}"
                                               class="form-control" placeholder="{{ \App\CPU\translate('نص التذييل') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($stock_limit = \App\Models\BusinessSetting::where('key', 'stock_limit')->first()->value)
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('حد المخزون الأدنى للتحذير') }}</label>
                                        <input type="number" name="stock_limit" value="{{ $stock_limit }}" min="0"
                                               class="form-control" placeholder="{{ \App\CPU\translate('حد المخزون') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('المنطقة الزمنية') }}</label>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('الرقم الضريبي') }}</label>
                                        <input class="form-control" type="text" name="vat_reg_no"
                                               placeholder="{{ \App\CPU\translate('الرقم الضريبي') }}" value="{{ $vat_reg_no }}">
                                    </div>
                                </div>
                                                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($kilometer= \App\Models\BusinessSetting::where(['key' => 'kilometer'])->first()->value)
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('الكيلومتر') }}</label>
                                        <input class="form-control" type="number" name="kilometer"
                                               placeholder="{{ \App\CPU\translate('الكيلومتر') }}" value="{{ $kilometer }}">
                                    </div>
                                </div>


                                                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($number_tax= \App\Models\BusinessSetting::where(['key' => 'number_tax'])->first()->value)
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('رقم الضريبي') }}</label>
                                        <input class="form-control" type="number" name="number_tax"
                                               placeholder="{{ \App\CPU\translate('رقم الضريبي') }}" value="{{ $number_tax }}">
                                    </div>
                                </div>

                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($color1= \App\Models\BusinessSetting::where(['key' => 'color1'])->first()->value)
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('لون الخلفية') }}</label>
                                        <input class="form-control" type="color" name="color1"
                                               placeholder="{{ \App\CPU\translate('لون الخلفية') }}" value="{{ $color1 }}">
                                    </div>
                                </div>
                                  <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    @php($color2= \App\Models\BusinessSetting::where(['key' => 'color2'])->first()->value)
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('لون الزر') }}</label>
                                        <input class="form-control" type="color" name="color2"
                                               placeholder="{{ \App\CPU\translate('لون الزر') }}" value="{{ $color2 }}">
                                    </div>
                                </div>
                      <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
    @php($cash = \App\Models\BusinessSetting::where(['key' => 'cash'])->first()->value)
    <div class="form-group">
        <label>{{ \App\CPU\translate('تفعيل الدفع نقدًا') }}</label>
        <select class="form-control" name="cash">
            <option value="1" {{ $cash == 1 ? 'selected' : '' }}>{{ \App\CPU\translate('مفعل') }}</option>
            <option value="0" {{ $cash == 0 ? 'selected' : '' }}>{{ \App\CPU\translate('غير مفعل') }}</option>
        </select>
    </div>
</div>

<div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
    @php($shabaka = \App\Models\BusinessSetting::where(['key' => 'shabaka'])->first()->value)
    <div class="form-group">
        <label>{{ \App\CPU\translate('تفعيل الدفع عبر شبكة') }}</label>
        <select class="form-control" name="shabaka">
            <option value="1" {{ $shabaka == 1 ? 'selected' : '' }}>{{ \App\CPU\translate('مفعل') }}</option>
            <option value="0" {{ $shabaka == 0 ? 'selected' : '' }}>{{ \App\CPU\translate('غير مفعل') }}</option>
        </select>
    </div>
</div>

<div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
    @php($agel = \App\Models\BusinessSetting::where(['key' => 'agel'])->first()->value)
    <div class="form-group">
        <label>{{ \App\CPU\translate('تفعيل الدفع الآجل') }}</label>
        <select class="form-control" name="agel">
            <option value="1" {{ $agel == 1 ? 'selected' : '' }}>{{ \App\CPU\translate('مفعل') }}</option>
            <option value="0" {{ $agel == 0 ? 'selected' : '' }}>{{ \App\CPU\translate('غير مفعل') }}</option>
        </select>
    </div>
</div>
                                <!--<div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">-->
                                ...
                                <!--    <div class="form-group">-->
                                <!--        <label class="input-label" for="exampleFormControlInput1">{{ \App\CPU\translate('الضريبة نسبة مئوية %') }}</label>-->
                                <!--        <input type="number" name="tax" value="{{ $tax }}"-->
                                <!--               class="form-control" placeholder="{{ \App\CPU\translate('الضريبة') }}" required>-->
                                <!--    </div>-->
                                <!--</div>-->
                                ...
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-2">
                                    ...
                                    <div class="form-group ">
                                        <label>{{ \App\CPU\translate('شعار المتجر') }}</label><small class="text-danger">* ( {{ \App\CPU\translate('نسبة 1:1') }} )</small>
                                        <div class="custom-file">
                                            <input type="file" name="shop_logo" id="customFileEg1" class="custom-file-input"
                                                   accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <label class="custom-file-label" for="customFileEg1">{{ \App\CPU\translate('اختر ملف') }}</label>
                                        </div>
                                        <center>
                                            <img class="img-one-bs my-4" id="viewer"
                                                 onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'" style="border:none;"
...
<script>
    ...
    $(function() {
        ...
        @php($tz = \App\Models\BusinessSetting::where('key', 'time_zone')->first()->value ?? '')
        $('[name=time_zone]').val("{{ $tz }}");

        // دالة لضبط الحد الأدنى والحد الأقصى
        window.enforceMinMax = function(el) {
            if (el.value !== "") {
                const val = parseInt(el.value, 10);
                if (val < parseInt(el.min, 10)) el.value = el.min;
                if (val > parseInt(el.max, 10)) el.value = el.max;
            }
        };

        // حفظ القيمة القديمة عند الضغط، وإرجاعها إذا كانت غير صالحة عند التحرير
        $("#pagination_limit")
            .on('keydown', function() {
                const v = $(this).val();
