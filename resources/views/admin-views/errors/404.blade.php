  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media (max-width: 400px) {
      .navbar { height: 70px; margin-bottom: 16px; }
      .navbar .logo { font-size: 1.7rem; }
      .main img { width: 160px; }
...
<body>
  ...
  <div class="main">
    ...
    <h1>خطأ 400</h1>
    <p class="subtitle">عذرًا! الطلب غير صالح (Bad Request). الرجاء التحقق والمحاولة مرة أخرى.</p>
    <div class="loader"></div>
    <p class="subtitle">إذا استمرت المشكلة، تواصل مع الدعم الفني.</p>
  </div>
