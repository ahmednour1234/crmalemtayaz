...
<div class="card shadow-sm mb-4">
  <div class="card-header bg-primary text-white rounded-top">
    <h5 class="mb-0" style="color:white;"><i class="bi bi-plus-lg me-2"></i> إضافة عقد جديد</h5>
  </div>
  <div class="card-body p-4">
    <form action="{{ route('admin.contracts.store') }}" method="POST">
      ...
      <div class="mt-4 text-center">
        ...
        <a href="{{ route('admin.contracts.index') }}" class="btn btn-outline-secondary px-4 ms-2">
          إلغاء
        </a>
      </div>
    </form>
