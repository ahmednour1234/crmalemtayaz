        ...
        <ol class="breadcrumb bg-white px-3 py-2 rounded shadow-sm">
            ...
            <li class="breadcrumb-item">
                <a href="#" class="text-primary">
                    {{ \App\CPU\translate('  تقرير إعمار  ديون العملاء') }}
                </a>
            </li>
    ...
    <div class="col-md-3 mb-2">
        ...
        <div id="printableArea">
            ...
            <div class="header-section print-only">
                ...
                <h2 style="margin-top: 20px;">تقرير إعمار ديون العملاء</h2>
            ...
            <div class="table-responsive">
                @php
                    ...
                    $customerCount = count($report);
                @endphp

 <table class="table align-middle mb-0" id="excel-table">
                <thead>
                    <tr>
